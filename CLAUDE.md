...
=== .ai/blade-livewire-conventions rules ===
...
=== .ai/website-purpose rules ===

#Website Purpose
This is going to be an e-commerce site running on Laravel Livewire with a Filiment admin back end. This is going to replace the customers current Woocommerce website. 

The customer sells handmade rustic wooden furniture worldwide, but is based in the south of England.

Customers won't be able to login.
